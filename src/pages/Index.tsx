            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              <AccordionItem value="item-3" className="bg-white rounded-lg border-2 px-6">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  ...
                  есть). Наши специалисты помогут собрать и правильно оформить все необходимые
                  документы.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4" className="bg-white rounded-lg border-2 px-6">
                <AccordionTrigger className="text-left hover:no-underline">
                  <span className="font-semibold">
                    Есть ли специальные условия для многодетных семей?
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Да! Мы имеем огромный опыт работы с программами государственной поддержки для
                  многодетных семей и предлагаем индивидуальные решения с учетом всех льгот и
                  преимуществ.
                </AccordionContent>
              </AccordionItem>
